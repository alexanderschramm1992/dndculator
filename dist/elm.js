...
var $author$project$Main$Model = function (dieFace) {
	return function (level) {
		return function (attack) {
			return function (touchOfDeath) {
				return function (weapon) {
					return function (blessedStrikes) {
...
var $author$project$Main$WhisperingScythe = 0;
...
var $author$project$Main$weaponFromString = function (string) {
	if (string === 'Whispering Scythe') {
		return $elm$core$Maybe$Just(0);
	} else {
		return $elm$core$Maybe$Nothing;
	}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 3:
				var attack = msg.a;
				var _v2 = $author$project$Main$attackTypeFromString(attack);
				if (!_v2.$) {
					var attackType = _v2.a;
					switch (attackType) {
						case 0:
							return _Utils_Tuple2(
								_Utils_update(
			...
			case 5:
				var weapon = msg.a;
				var _v4 = $author$project$Main$weaponFromString(weapon);
				if (!_v4.$) {
					var parsedWeapon = _v4.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{O: parsedWeapon}),
			...
			case 8:
				var spell = msg.a;
				var _v5 = $author$project$Main$spellFromString(spell);
				if (!_v5.$) {
					var parsedSpell = _v5.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{B: parsedSpell}),
			...
			case 9:
				var slot = msg.a;
				var _v6 = $elm$core$String$toInt(slot);
				if (!_v6.$) {
					var parsedSlot = _v6.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{C: parsedSlot}),
...
var $author$project$Main$DiceAmount = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Main$SupplementedAmount = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Main$combineDamageAmounts = F2(
	function (firstAmount, secondAmount) {
		combineDamageAmounts:
		while (true) {
			var _v0 = _Utils_Tuple2(firstAmount, secondAmount);
			_v0$1:
			while (true) {
				switch (_v0.a.$) {
					case 0:
					...
					case 1:
						switch (_v0.b.$) {
							...
							case 1:
								var first = _v0.a;
								var firstFactor = first.a;
								var firstDice = first.b;
								var second = _v0.b;
								var secondFactor = second.a;
								var secondDice = second.b;
								return _Utils_eq(firstDice, secondDice) ? A2($author$project$Main$DiceAmount, firstFactor + secondFactor, firstDice) : A2($author$project$Main$CombinedAmount, first, second);
							case 2:
								var first = _v0.a;
								var _v3 = _v0.b;
								var second = _v3.a;
								var supplement = _v3.b;
								return A2(
									$author$project$Main$SupplementedAmount,
									A2($author$project$Main$combineDamageAmounts, first, second),
									supplement);
							default:
								var diceAmount = _v0.a;
								var _v4 = _v0.b;
								var first = _v4.a;
								var second = _v4.b;
								return A2(
									$author$project$Main$CombinedAmount,
									A2($author$project$Main$combineDamageAmounts, diceAmount, first),
									second);
						}
					case 2:
						switch (_v0.b.$) {
							...
							case 2:
								var _v5 = _v0.a;
								var firstSupplementedAmount = _v5.a;
								var firstSupplement = _v5.b;
								var _v6 = _v0.b;
								var secondSupplementedAmount = _v6.a;
								var secondSupplement = _v6.b;
								return A2(
									$author$project$Main$SupplementedAmount,
									A2($author$project$Main$combineDamageAmounts, firstSupplementedAmount, secondSupplementedAmount),
									firstSupplement + secondSupplement);
							case 3:
								var supplementedAmount = _v0.a;
								var _v7 = _v0.b;
								var first = _v7.a;
								var second = _v7.b;
								return A2(
									$author$project$Main$CombinedAmount,
									A2($author$project$Main$combineDamageAmounts, supplementedAmount, first),
									second);
							default:
								var first = _v0.a;
								var second = _v0.b;
								var $temp$firstAmount = second,
									$temp$secondAmount = first;
								firstAmount = $temp$firstAmount;
								secondAmount = $temp$secondAmount;
								continue combineDamageAmounts;
						}
					default:
						switch (_v0.b.$) {
							case 0:
							...
							case 3:
								var _v8 = _v0.a;
								var combinedFirst = _v8.a;
								var combinedSecond = _v8.b;
								var second = _v0.b;
								return A2(
									$author$project$Main$CombinedAmount,
									A2($author$project$Main$combineDamageAmounts, combinedFirst, second),
									combinedSecond);
							default:
								var first = _v0.a;
								var second = _v0.b;
...
var $author$project$Main$combineDamageDescriptorsInternal = function (descriptors) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (desc, acc) {
...
var $author$project$Main$combineDamageDescriptors = function (descriptors) {
	return A2(
		...
		A2(
			$elm$core$List$map,
			function (_v0) {
				var damageType = _v0.a;
				var amount = _v0.b;
				return A2(
					$elm$core$Maybe$map,
					$author$project$Main$DamageDescriptor(amount),
					$author$project$Main$damageTypeFromString(damageType));
			},
...
var $author$project$Main$spellDamageOf = F4(
	function (spell, level, spellslot, enemyDamaged) {
		switch (spell) {
			case 0:
				return {
...
var $author$project$Main$calculateDamageDescriptors = function (model) {
	...
	switch (_v0) {
		...
		case 1:
			return $author$project$Main$calculateMeleeSpellAttackDamageDescriptors(model);
		default:
			return $author$project$Main$calculateRangedSpellAttackDamageDescriptors(model);
	}
};
var $author$project$Main$diceTypeToString = function (dice) {
	switch (dice) {
		case 0:
			return 'D4';
		case 1:
...
var $author$project$Main$damageAmountView = function (amount) {
	switch (amount.$) {
		case 0:
			return A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('no-amount')
					]),
				_List_Nil);
		case 1:
			var factor = amount.a;
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('dice-amount')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						...
						$elm$html$Html$text(' ⨉ '),
						$elm$html$Html$text(
						$author$project$Main$diceTypeToString(dice))
					]));
		case 2:
			var supplementedAmount = amount.a;
			var supplement = amount.b;
			return A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('supplemented-amount')
					]),
				_List_fromArray(
					[
						$author$project$Main$damageAmountView(supplementedAmount),
						function () {
						if (!supplementedAmount.$) {
						...
						$elm$html$Html$text(
						$elm$core$String$fromInt(supplement))
					]));
		default:
			var first = amount.a;
			var second = amount.b;
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('combined-amount')
					]),
				_List_fromArray(
					[
						$author$project$Main$damageAmountView(first),
						$elm$html$Html$text(' + '),
						$author$project$Main$damageAmountView(second)
					]));
	}
};
...
var $author$project$Main$attackTypeToString = function (attackType) {
	switch (attackType) {
		case 0:
...
var $author$project$Main$toOption = function (description) {
	return A2(
...
var $author$project$Main$selectAttackType = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Attack Type')
				])),
			A2(
			$elm$html$Html$select,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('attack-type'),
					$elm$html$Html$Events$onInput($author$project$Main$AttackTypeChanged)
				]),
			A2(
				$elm$core$List$map,
				$author$project$Main$toOption,
				A2($elm$core$List$map, $author$project$Main$attackTypeToString, $author$project$Main$attackTypes)))
		]));
var $author$project$Main$SpellChanged = function (a) {
	return {$: 8, a: a};
};
...
var $author$project$Main$weaponToString = function (weapon) {
	return 'Whispering Scythe';
};
var $author$project$Main$weapons = _List_fromArray(
	[0]);
var $author$project$Main$selectWeapon = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('weapon'),
					$elm$html$Html$Events$onInput($author$project$Main$WeaponChanged)
				]),
			A2(
				$elm$core$List$map,
				$author$project$Main$toOption,
				A2($elm$core$List$map, $author$project$Main$weaponToString, $author$project$Main$weapons)))
		]));
var $author$project$Main$LevelChanged = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$BlessedStrikesToggled = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$Main$checkBlessedStrikes = function (isActive) {
	return A2(
		$elm$html$Html$label,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onCheck($author$project$Main$BlessedStrikesToggled)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$span,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(' Blessed Strikes')
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('checkbox'),
						$elm$html$Html$Attributes$checked(isActive),
						$elm$html$Html$Events$onCheck($author$project$Main$EnemyDamagedToggled)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$span,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(' Enemy damaged')
					]))
			]));
};
var $author$project$Main$SpiritShroudToggled = function (a) {
	return {$: 7, a: a};
};
var $author$project$Main$checkSpiritShroud = function (isActive) {
	return A2(
		$elm$html$Html$label,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('checkbox'),
						$elm$html$Html$Attributes$checked(isActive),
						$elm$html$Html$Events$onCheck($author$project$Main$SpiritShroudToggled)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$span,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(' Spirit Shroud')
					]))
			]));
};
var $author$project$Main$TouchOfDeathToggled = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$checkTouchOfDeath = function (isActive) {
	return A2(
		$elm$html$Html$label,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('checkbox'),
						$elm$html$Html$Attributes$checked(isActive),
						$elm$html$Html$Events$onCheck($author$project$Main$TouchOfDeathToggled)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$span,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(' Touch of Death')
					]))
			]));
};
var $author$project$Main$setModifiers = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$SpellslotChanged = function (a) {
	return {$: 9, a: a};
};
var $author$project$Main$setSpellSlot = function (slot) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('card margin padding')
			]),
		_List_fromArray(
			[
				...
				switch (_v0) {
					case 0:
						return A2(
							...
							_List_fromArray(
								[
									$author$project$Main$selectWeapon,
